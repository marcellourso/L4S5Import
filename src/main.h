...
/* Private defines -----------------------------------------------------------*/
#define ST25DV04K_RF_DISABLE_Pin GPIO_PIN_2
#define ST25DV04K_RF_DISABLE_GPIO_Port GPIOE
#define USB_OTG_FS_OVRCR_EXTI3_Pin GPIO_PIN_3
#define USB_OTG_FS_OVRCR_EXTI3_GPIO_Port GPIOE
#define ST25DV04K_GPO_Pin GPIO_PIN_4
#define ST25DV04K_GPO_GPIO_Port GPIOE
...
#define USB_OTG_FS_PWR_EN_EXTI_IRQn EXTI15_10_IRQn
...
#define STSAFE_A110_RESET_Pin GPIO_PIN_7
#define STSAFE_A110_RESET_GPIO_Port GPIOD
